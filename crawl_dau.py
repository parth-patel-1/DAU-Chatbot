...
async def safe_process_chunk(chunk, i, url):
    async with sem:
        return await process_chunk(chunk, i, url)
...
async def process_and_store_document(url: str, markdown: str):
    ...
    tasks = [
        safe_process_chunk(chunk, i, url) 
...
def get_dau_urls() -> List[str]:
    """Get URLs from DAU sitemap."""
    sitemap_url = "https://www.daiict.ac.in/sitemap.xml"
    try:
